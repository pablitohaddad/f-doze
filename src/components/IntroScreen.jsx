...
function IntroScreen({ onStart, tempoTotal, ranking, onRankingUpdate, loading }) {
    ...
    return (
        <div style={{ padding: '30px', border: '1px solid #39ff14', textAlign: 'center' }}>
            <h2>BEM-VINDO AO DESAFIO F12: BYPASS NO FRONT-END</h2>

            <p style={{ maxWidth: '600px', margin: '20px auto', color: '#8b949e' }}>
                Este é um desafio prático para aprender a utilizar as **Ferramentas de Desenvolvedor (DevTools)** do seu navegador (pressione F12). Cada nível exige que você utilize uma aba diferente (Network, Console, Elements, etc.) para "quebrar" o front-end e prosseguir.
            </p>
            ...
            <p style={{ marginTop: '50px', fontSize: '0.8em', color: '#8b949e' }}>
                Projeto feito para demonstrar o conceito F12.
            </p>
            <RankingScreen
                isIntro={true}
